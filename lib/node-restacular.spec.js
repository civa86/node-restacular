(function () {
    ...
    describe("[node-restacular][node-restacular.js]", function () {
        ...
        it("should throw error if no options given", function(done){
            expect(function(){
                rest.launchServer();
        ...
        it("should throw error if no callback given", function(done){
            expect(function(){
                rest.launchServer({});
        ...
        it("should throw error if db adapter not found", function(done){
            expect(function(){
        ...
        it("should have a working webserver", function (done) {
        ...
        it("should have a live api system", function (done) {
        ...
        it("should have a post entity and it is empty", function (done) {
        ...
        it("should have a post entity with one record", function (done) {
            var url = "http://localhost:" + restConfiguration.server.port + "/api/post";
            request(url, function (error, response, body) {
                var res = JSON.parse(body);
                expect(res.code).toEqual(200);
        ...
        it("should count post entity returning 1", function (done) {
        ...
        it("should get a post record by id", function (done) {
        ...
        it("should create another post record", function (done) {
            var url = "http://localhost:" + restConfiguration.server.port + "/api/post";
        ...
        it("should have a post entity with two records", function (done) {
            var url = "http://localhost:" + restConfiguration.server.port + "/api/post";
            request(url, function (error, response, body) {
                var res = JSON.parse(body);
                expect(res.code).toEqual(200);
        ...
        it("should delete record by id in post entity", function (done) {
            var url = "http://localhost:" + restConfiguration.server.port + "/api/post/" + id;
            request({uri: url, method: "DELETE"}, function (error, response, body) {
                var res = JSON.parse(body);
                expect(res.code).toEqual(200);
        ...
        it("it should have a post entity with one record, not the previous deleted one", function (done) {
            var url = "http://localhost:" + restConfiguration.server.port + "/api/post";
            request(url, function (error, response, body) {
                var res = JSON.parse(body);
                expect(res.code).toEqual(200);
        ...
        it("should trucante post entity", function (done) {
            var url = "http://localhost:" + restConfiguration.server.port + "/api/post";
            request({uri: url, method: "DELETE"}, function (error, response, body) {
                var res = JSON.parse(body);
                expect(res.code).toEqual(200);
        ...
        it("should have a post entity and it is empty again!", function (done) {
            var url = "http://localhost:" + restConfiguration.server.port + "/api/post";
            request(url, function (error, response, body) {
                var res = JSON.parse(body);
                expect(res.code).toEqual(200);
        ...
        it("should be forbidden for any GET request", function (done) {
            var url = "http://localhost:" + restConfiguration.server.port + "/api/post";
            request(url, function (error, response, body) {
                var res = JSON.parse(body);
                console.log(res);
